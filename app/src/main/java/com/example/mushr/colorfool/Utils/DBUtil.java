...
public class DBUtil extends SQLiteOpenHelper {
    private static final String db_name = "color.db";     //  数据库名
    private static String db_path = "/data/data/com.example.mushr.colorfool/databases/";    //  要拷贝到的路径
    ...
    public void CopyDB(Context context) {
        ...
        if (!(new File(db_path + db_name)).exists()) {
            ...
            try {
                ...
                InputStream is = context.getAssets().open("color.db");
